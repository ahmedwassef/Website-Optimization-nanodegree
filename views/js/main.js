...
var resizePizzas = function(size) {
  ...
  //delete sizeSwitcher function and optmize changePizzaSizes
  ...
  function changePizzaSizes(size) {
    switch(size) {
      ...
      case "3":
        ...
        break;
      default:
        console.log("error in changePizzaSizes function ");
    }
    // replaced querySelector with getElementsByClassName
    var randompizzas= document.getElementsByClassName("randomPizzaContainer");
    //save the array length in a local variable
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // replace  querySelector with  getElementById and move it  Outside the loop
  var movingPizzas = document.getElementById('movingPizzas1');
  // change  loop counter from 200 to 24 and Declaring the elem variable (var elem;) in the initialisation of the for-loop
